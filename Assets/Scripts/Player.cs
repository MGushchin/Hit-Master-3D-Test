...
public class Player : MonoBehaviour
{
    ...
    public void AreaCleared(EnemySpot completedPoint) //ћетод подписываетс€ на прохождение текущей не пройденной локации и при срабатывании продолжает путь
    {
    ...
    {
        if (movePoints.Count > 0) //ƒвигаемс€ только если очередь точек прохождени€ не пуст
        {
